    ...
    with st.spinner("正在分析数据..."):
        ...
        if llm:
            ...
            with st.spinner("正在生成综合报告..."):
                summary_prompt = f"""
# 你是专业的政策评估研究员。请基于以下三种方法对【{POLICY_NAME}】的评估结果，撰写一份**学术论文摘要风格**的综合政策解读报告。要求严格按照以下结构输出，语言正式、简洁、逻辑清晰：
# 
# 【背景与问题】简述智能制造政策的背景，以及研究其对供应链韧性影响的重要性。
# 
# 【研究方法】说明使用了普通DID、PSM-DID、双重机器学习(DML)三种方法，并简要说明各自特点（如DML控制高维协变量、非线性关系）。
# 
# 【主要发现】汇报三种方法的估计结果：系数（或ATE）、显著性、样本量、R²等。指出一致性和差异，并解释DML结果为何更可靠。
# 
# 【作用机制】结合理论（供应链管理理论、知识管理理论），分析智能制造政策通过哪些具体途径影响供应链韧性。至少包括：知识深化重构、知识拓展重构、降低研发成本、提升技术能力、优化生产流程等。
# 
# 【进一步分析】讨论可能的异质性因素（如政策执行能力、知识产权保护、供需稳定关系等）或溢出效应。
# 
# 【结论与建议】总结研究结论，并从政府和企业两个角度提出具体、可操作的政策建议。
# 
# 评估结果：
...
# 请输出500-800字，严格按上述七部分结构，语言风格参考权威学术期刊摘要。
